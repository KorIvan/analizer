 ...
 * @author float
 */
public class ReverseWaveletTransformTest {
    ...
    private double[][] doWaveletTransformTest(double[] data, int window) {
     ...
     private double[][] doReverseWaveletTransformTest(double[] data, int window) {
        Transform t = new Transform(new FastWaveletTransform(new Haar1()));
...
//        double[][] data = testData.get2DSignal(100, 200, frameWidth, discretization);
        ...
        //1. Create the frame.
        JFrame frame = new JFrame("Reverse WT Freq=" + frequency + ", Discret=" + discretization + ", Length=" + length + ", Ampl=" + ampl);
